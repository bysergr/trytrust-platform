...
export default async function SecurityPage() {
  ...
  return <ProtectedShell><main className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-8 sm:py-12">
    ...
    <section className="surface rounded-3xl border p-5 sm:p-8"><HankoProfile demo={user?.isDemo} /></section>
  </main></ProtectedShell>
}
